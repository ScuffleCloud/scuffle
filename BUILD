        ...
        "rusty_ffmpeg": [
            crate.annotation(
                build_script_env = {
                    ...
                    "LIBCLANG_PATH": "$(execpath @//build/toolchains/llvm:libclang)",
                    "BINDGEN_EXTRA_CLANG_ARGS": "--sysroot=$(execpath @//build/toolchains/llvm:sysroot)",
                },
                build_script_data = [
                    "@//build/toolchains/ffmpeg:lib",
                    "@//build/toolchains/ffmpeg:include",
                    "@//build/toolchains/llvm:libclang",
                    "@//build/toolchains/llvm:sysroot",
                ],
            ),
        ],
    },
