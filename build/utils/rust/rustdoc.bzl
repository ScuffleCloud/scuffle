...
rustdoc = rule(
    ...
    attrs = {
        ...
        "_rustdoc_wrapper": attr.label(
            default = Label("//build/utils/rust/doc/wrapper"),
            cfg = "exec",
            executable = True,
        ),
...
rustdoc_test = rule(
    ...
    attrs = {
        ...
        "_rust_doctest_builder": attr.label(
            default = Label("//build/utils/rust/doc/test/builder"),
            cfg = "exec",
            executable = True,
        ),
        "_rust_doctest_runner": attr.label(
            default = Label("//build/utils/rust/doc/test/runner"),
            cfg = "exec",
            executable = True,
        ),
        "_process_wrapper": attr.label(
...
rustdoc_merge = rule(
    ...
    attrs = {
        ...
        "_rustdoc_merger": attr.label(
            default = "//build/utils/rust/doc/merger",
            cfg = "exec",
            executable = True,
        ),
    },
