...
impl Object {
    ...
    pub fn is_empty(&self) -> bool {
        ...
        self == &*DEFAULT || (serde_json::to_string(self).unwrap_or("{}".to_string()) == "{}".to_string())
    }
...
fn merge_inverted_if_possible(value_opt: &mut Option<Schema>, other_opt: &mut Option<Schema>) {
    ...
    // If merge is not fully successful however, just leave separated.
    ...
    match (value, other) {
        (Schema::Object(value_obj), Schema::Object(other_obj)) => {
...
mod tests {
    ...
    fn merge_objects_with_not_enum_values() {
        ...
        let not_nan = Schema::object(
            Object::builder().not(Schema::object(
                Object::builder()
                    .schema_type(Type::String)
                    .enum_values(vec![
                        serde_json::Value::from("NaN"),
