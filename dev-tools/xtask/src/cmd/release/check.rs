...
use crate::cmd::release::utils::{LicenseKind, PackageError, PackageErrorMissing, PackageFile};
        ...
        for group in groups.values() {
            ...
            for package in group {
                if let Some(next_version) = package.next_version() {
                    ...
                    tracing::info!("{} requires a version bump to {next_version}{extra}", package.name);
