...
_NORMAL_DEPENDENCIES = {
    "cloud/core": {
        _REQUIRED_FEATURE: {
            _COMMON_CONDITION: {
                ...
                "rustls": Label("@cargo_vendor//:rustls-0.23.33"),
    ...
    "crates/bootstrap/derive": {
        _REQUIRED_FEATURE: {
            _COMMON_CONDITION: {
                ...
                "syn": Label("@cargo_vendor//:syn-2.0.107"),
            },
        },
    },
    "crates/bytes-util": {
    ...
    "crates/pprof": {
        _REQUIRED_FEATURE: {
            "cfg(unix)": {
                "flate2": Label("@cargo_vendor//:flate2-1.1.4"),
    ...
    "crates/settings": {
        ...
        "clap": {
            _COMMON_CONDITION: {
                "clap": Label("@cargo_vendor//:clap-4.5.49"),
            },
        },
        "minijinja": {
            _COMMON_CONDITION: {
...
def crate_repositories():
    ...
    maybe(
        ...
        build_file = Label("//vendor/cargo:BUILD.cc-1.2.41.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "cargo_vendor__clap-4.5.49",
        ...
        build_file = Label("//vendor/cargo:BUILD.clap-4.5.49.bazel"),
    )

    maybe(
        http_archive,
        name = "cargo_vendor__clap_builder-4.5.49",
        ...
        build_file = Label("//vendor/cargo:BUILD.clap_builder-4.5.49.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "cargo_vendor__deranged-0.5.4",
        ...
        build_file = Label("//vendor/cargo:BUILD.deranged-0.5.4.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "cargo_vendor__flate2-1.1.4",
        ...
        build_file = Label("//vendor/cargo:BUILD.flate2-1.1.4.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "cargo_vendor__globset-0.4.17",
        ...
        build_file = Label("//vendor/cargo:BUILD.globset-0.4.17.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "cargo_vendor__rustls-0.23.33",
        sha256 = "751e04a496ca00bb97a5e043158d23d66b5aabf2e1d5aa2a0aaebb1aafe6f82c",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/rustls/0.23.33/download"],
        strip_prefix = "rustls-0.23.33",
        build_file = Label("//vendor/cargo:BUILD.rustls-0.23.33.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "cargo_vendor__serde_with-3.15.0",
        sha256 = "6093cd8c01b25262b84927e0f7151692158fab02d961e04c979d3903eba7ecc5",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/serde_with/3.15.0/download"],
        strip_prefix = "serde_with-3.15.0",
        build_file = Label("//vendor/cargo:BUILD.serde_with-3.15.0.bazel"),
    )

    maybe(
        http_archive,
        name = "cargo_vendor__serde_with_macros-3.15.0",
        sha256 = "a7e6c180db0816026a61afa1cff5344fb7ebded7e4d3062772179f2501481c27",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/serde_with_macros/3.15.0/download"],
        strip_prefix = "serde_with_macros-3.15.0",
        build_file = Label("//vendor/cargo:BUILD.serde_with_macros-3.15.0.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "cargo_vendor__syn-2.0.107",
        ...
        build_file = Label("//vendor/cargo:BUILD.syn-2.0.107.bazel"),
    )
    ...
    return [
        ...
        struct(repo = "cargo_vendor__clap-4.5.49", is_dev_dep = False),
        ...
        struct(repo = "cargo_vendor__flate2-1.1.4", is_dev_dep = False),
        ...
        struct(repo = "cargo_vendor__rustls-0.23.33", is_dev_dep = False),
        ...
        struct(repo = "cargo_vendor__syn-2.0.107", is_dev_dep = False),
