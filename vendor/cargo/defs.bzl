    ...
    "cloud/core": {
        _REQUIRED_FEATURE: {
            _COMMON_CONDITION: {
                ...
                "axum": Label("@cargo_vendor//:axum-0.8.6"),
    ...
    "crates/bootstrap/derive": {
        _REQUIRED_FEATURE: {
            _COMMON_CONDITION: {
                ...
                "syn": Label("@cargo_vendor//:syn-2.0.109"),
            },
        },
    },
    "crates/bytes-util": {
    ...
    "crates/http": {
        ...
        "http1": {
            _COMMON_CONDITION: {
                ...
                "hyper-util": Label("@cargo_vendor//:hyper-util-0.1.17"),
                "libc": Label("@cargo_vendor//:libc-0.2.177"),
            },
        },
        "http2": {
...
def crate_repositories():
    ...
    maybe(
        http_archive,
        name = "cargo_vendor__aws-lc-rs-1.14.1",
        sha256 = "879b6c89592deb404ba4dc0ae6b58ffd1795c78991cbb5b8bc441c48a070440d",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/aws-lc-rs/1.14.1/download"],
        strip_prefix = "aws-lc-rs-1.14.1",
        build_file = Label("//vendor/cargo:BUILD.aws-lc-rs-1.14.1.bazel"),
    )

    maybe(
        http_archive,
        name = "cargo_vendor__aws-lc-sys-0.32.3",
        sha256 = "107a4e9d9cab9963e04e84bb8dee0e25f2a987f9a8bad5ed054abd439caa8f8c",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/aws-lc-sys/0.32.3/download"],
        strip_prefix = "aws-lc-sys-0.32.3",
        build_file = Label("//vendor/cargo:BUILD.aws-lc-sys-0.32.3.bazel"),
    )

    maybe(
        http_archive,
        name = "cargo_vendor__axum-0.8.6",
        ...
        build_file = Label("//vendor/cargo:BUILD.axum-0.8.6.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//vendor/cargo:BUILD.cc-1.2.45.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "cargo_vendor__find-msvc-tools-0.1.4",
        ...
        build_file = Label("//vendor/cargo:BUILD.find-msvc-tools-0.1.4.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "cargo_vendor__generic-array-0.14.9",
        ...
        build_file = Label("//vendor/cargo:BUILD.generic-array-0.14.9.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "cargo_vendor__hyper-util-0.1.17",
        ...
        build_file = Label("//vendor/cargo:BUILD.hyper-util-0.1.17.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "cargo_vendor__indicatif-0.18.2",
        ...
        build_file = Label("//vendor/cargo:BUILD.indicatif-0.18.2.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "cargo_vendor__linked_hash_set-0.1.5",
        sha256 = "bae85b5be22d9843c80e5fc80e9b64c8a3b1f98f867c709956eca3efff4e92e2",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/linked_hash_set/0.1.5/download"],
        strip_prefix = "linked_hash_set-0.1.5",
        build_file = Label("//vendor/cargo:BUILD.linked_hash_set-0.1.5.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "cargo_vendor__num-bigint-dig-0.8.5",
        sha256 = "82c79c15c05d4bf82b6f5ef163104cc81a760d8e874d38ac50ab67c8877b647b",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/num-bigint-dig/0.8.5/download"],
        strip_prefix = "num-bigint-dig-0.8.5",
        build_file = Label("//vendor/cargo:BUILD.num-bigint-dig-0.8.5.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "cargo_vendor__serde_with-3.15.1",
        ...
        build_file = Label("//vendor/cargo:BUILD.serde_with-3.15.1.bazel"),
    )

    maybe(
        http_archive,
        name = "cargo_vendor__serde_with_macros-3.15.1",
        ...
        build_file = Label("//vendor/cargo:BUILD.serde_with_macros-3.15.1.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "cargo_vendor__syn-2.0.109",
        ...
        build_file = Label("//vendor/cargo:BUILD.syn-2.0.109.bazel"),
    )
    ...
    return [
        ...
        struct(repo = "cargo_vendor__axum-0.8.6", is_dev_dep = False),
        ...
        struct(repo = "cargo_vendor__hyper-util-0.1.17", is_dev_dep = False),
        ...
        struct(repo = "cargo_vendor__syn-2.0.109", is_dev_dep = False),
