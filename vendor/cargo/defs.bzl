...
def crate_repositories():
    ...
    maybe(
        http_archive,
        name = "cargo_vendor__iddqd-0.3.10",
        sha256 = "b4276965d327336534e0f595a343ec9b68296d46d16323d499b4fd8bb8408f2a",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/iddqd/0.3.10/download"],
        strip_prefix = "iddqd-0.3.10",
        build_file = Label("//vendor/cargo:BUILD.iddqd-0.3.10.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "cargo_vendor__toml_edit-0.23.3",
        sha256 = "17d3b47e6b7a040216ae5302712c94d1cf88c95b47efa80e2c59ce96c878267e",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/toml_edit/0.23.3/download"],
        strip_prefix = "toml_edit-0.23.3",
        build_file = Label("//vendor/cargo:BUILD.toml_edit-0.23.3.bazel"),
    )
    ...
    return [
        ...
        struct(repo = "cargo_vendor__reqwest-0.12.23", is_dev_dep = True),
