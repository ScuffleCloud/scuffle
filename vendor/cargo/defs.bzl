...
_NORMAL_DEPENDENCIES = {
    "cloud/core": {
        _REQUIRED_FEATURE: {
            _COMMON_CONDITION: {
                ...
                "rustls": Label("@cargo_vendor//:rustls-0.23.34"),
                ...
                "swagger-ui-dist": Label("@cargo_vendor//:swagger-ui-dist-5.29.5"),
    ...
    "crates/bootstrap/derive": {
        _REQUIRED_FEATURE: {
            _COMMON_CONDITION: {
                ...
                "quote": Label("@cargo_vendor//:quote-1.0.41"),
                "syn": Label("@cargo_vendor//:syn-2.0.108"),
            },
        },
    },
    "crates/bytes-util": {
    ...
    "crates/settings": {
        ...
        "clap": {
            _COMMON_CONDITION: {
                "clap": Label("@cargo_vendor//:clap-4.5.50"),
            },
        },
        "minijinja": {
            _COMMON_CONDITION: {
    ...
    "tools/cargo/clippy": {
        _REQUIRED_FEATURE: {
            _COMMON_CONDITION: {
                ...
                "env_logger": Label("@cargo_vendor//:env_logger-0.11.8"),
                "log": Label("@cargo_vendor//:log-0.4.28"),
                "rustfix": Label("@cargo_vendor//:rustfix-0.9.2"),
                "serde_json": Label("@cargo_vendor//:serde_json-1.0.145"),
            },
        },
    },
...
def crate_repositories():
    ...
    maybe(
        ...
        build_file = Label("//vendor/cargo:BUILD.cc-1.2.43.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "cargo_vendor__cfg-expr-0.20.3",
        sha256 = "1a2c5f3bf25ec225351aa1c8e230d04d880d3bd89dea133537dafad4ae291e5c",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/cfg-expr/0.20.3/download"],
        strip_prefix = "cfg-expr-0.20.3",
        build_file = Label("//vendor/cargo:BUILD.cfg-expr-0.20.3.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "cargo_vendor__clap-4.5.50",
        ...
        build_file = Label("//vendor/cargo:BUILD.clap-4.5.50.bazel"),
    )

    maybe(
        http_archive,
        name = "cargo_vendor__clap_builder-4.5.50",
        ...
        build_file = Label("//vendor/cargo:BUILD.clap_builder-4.5.50.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "cargo_vendor__erased-serde-0.4.8",
        ...
        build_file = Label("//vendor/cargo:BUILD.erased-serde-0.4.8.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "cargo_vendor__indicatif-0.18.1",
        sha256 = "e2e0ddd45fe8e09ee1a607920b12271f8a5528a41ecaf6e1d1440d6493315b6b",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/indicatif/0.18.1/download"],
        strip_prefix = "indicatif-0.18.1",
        build_file = Label("//vendor/cargo:BUILD.indicatif-0.18.1.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "cargo_vendor__js-sys-0.3.81",
        ...
        build_file = Label("//vendor/cargo:BUILD.js-sys-0.3.81.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "cargo_vendor__moxcms-0.7.7",
        sha256 = "c588e11a3082784af229e23e8e4ecf5bcc6fbe4f69101e0421ce8d79da7f0b40",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/moxcms/0.7.7/download"],
        strip_prefix = "moxcms-0.7.7",
        build_file = Label("//vendor/cargo:BUILD.moxcms-0.7.7.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "cargo_vendor__newtype-uuid-1.3.1",
        sha256 = "74d1216f62e63be5fb25a9ecd1e2b37b1556a9b8c02f4831770f5d01df85c226",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/newtype-uuid/1.3.1/download"],
        strip_prefix = "newtype-uuid-1.3.1",
        build_file = Label("//vendor/cargo:BUILD.newtype-uuid-1.3.1.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "cargo_vendor__openssl-0.10.74",
        ...
        build_file = Label("//vendor/cargo:BUILD.openssl-0.10.74.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "cargo_vendor__openssl-sys-0.9.110",
        ...
        build_file = Label("//vendor/cargo:BUILD.openssl-sys-0.9.110.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//vendor/cargo:BUILD.psm-0.1.27.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "cargo_vendor__quote-1.0.41",
        ...
        build_file = Label("//vendor/cargo:BUILD.quote-1.0.41.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "cargo_vendor__rustfix-0.9.2",
        sha256 = "662decac6b0486a3bfb3723a0621eb12f5ae199488ddf87582d09f8c7b3e9889",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/rustfix/0.9.2/download"],
        strip_prefix = "rustfix-0.9.2",
        build_file = Label("//vendor/cargo:BUILD.rustfix-0.9.2.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "cargo_vendor__rustls-0.23.34",
        ...
        build_file = Label("//vendor/cargo:BUILD.rustls-0.23.34.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "cargo_vendor__rustls-webpki-0.103.7",
        ...
        build_file = Label("//vendor/cargo:BUILD.rustls-webpki-0.103.7.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "cargo_vendor__swagger-ui-dist-5.29.5",
        sha256 = "7d827bc1e5214b308219775d0f9de003f306ffa3f51371db7be202bce384c99e",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/swagger-ui-dist/5.29.5/download"],
        strip_prefix = "swagger-ui-dist-5.29.5",
        build_file = Label("//vendor/cargo:BUILD.swagger-ui-dist-5.29.5.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "cargo_vendor__syn-2.0.108",
        ...
        build_file = Label("//vendor/cargo:BUILD.syn-2.0.108.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "cargo_vendor__unicode-ident-1.0.20",
        ...
        build_file = Label("//vendor/cargo:BUILD.unicode-ident-1.0.20.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "cargo_vendor__wasm-bindgen-0.2.104",
        ...
        build_file = Label("//vendor/cargo:BUILD.wasm-bindgen-0.2.104.bazel"),
    )

    maybe(
        http_archive,
        name = "cargo_vendor__wasm-bindgen-backend-0.2.104",
        ...
        build_file = Label("//vendor/cargo:BUILD.wasm-bindgen-backend-0.2.104.bazel"),
    )

    maybe(
        http_archive,
        name = "cargo_vendor__wasm-bindgen-futures-0.4.54",
        ...
        build_file = Label("//vendor/cargo:BUILD.wasm-bindgen-futures-0.4.54.bazel"),
    )

    maybe(
        http_archive,
        name = "cargo_vendor__wasm-bindgen-macro-0.2.104",
        ...
        build_file = Label("//vendor/cargo:BUILD.wasm-bindgen-macro-0.2.104.bazel"),
    )

    maybe(
        http_archive,
        name = "cargo_vendor__wasm-bindgen-macro-support-0.2.104",
        ...
        build_file = Label("//vendor/cargo:BUILD.wasm-bindgen-macro-support-0.2.104.bazel"),
    )

    maybe(
        http_archive,
        name = "cargo_vendor__wasm-bindgen-shared-0.2.104",
        ...
        build_file = Label("//vendor/cargo:BUILD.wasm-bindgen-shared-0.2.104.bazel"),
    )

    maybe(
        http_archive,
        name = "cargo_vendor__web-sys-0.3.81",
        ...
        build_file = Label("//vendor/cargo:BUILD.web-sys-0.3.81.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "cargo_vendor__webpki-root-certs-1.0.3",
        ...
        build_file = Label("//vendor/cargo:BUILD.webpki-root-certs-1.0.3.bazel"),
    )

    maybe(
        http_archive,
        name = "cargo_vendor__webpki-roots-1.0.3",
        ...
        build_file = Label("//vendor/cargo:BUILD.webpki-roots-1.0.3.bazel"),
    )
    ...
    return [
        ...
        struct(repo = "cargo_vendor__clap-4.5.50", is_dev_dep = False),
        ...
        struct(repo = "cargo_vendor__quote-1.0.41", is_dev_dep = False),
        ...
        struct(repo = "cargo_vendor__rustfix-0.9.2", is_dev_dep = False),
        struct(repo = "cargo_vendor__rustls-0.23.34", is_dev_dep = False),
        ...
        struct(repo = "cargo_vendor__swagger-ui-dist-5.29.5", is_dev_dep = False),
        struct(repo = "cargo_vendor__syn-2.0.108", is_dev_dep = False),
