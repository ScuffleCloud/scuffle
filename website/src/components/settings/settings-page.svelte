    ...
    actions: [
      {
        ...
        variant: "primary",
        onClick: () => {
          userSettings.twoFactorAuth.enabled = !userSettings.twoFactorAuth
            .enabled;
    ...
    actions: [
      {
        ...
        onClick: () => {
          userSettings.notifications.email.enabled = !userSettings.notifications
            .email.enabled;
          console.log(
    ...
    actions: [
      {
        ...
        onClick: () => {
          userSettings.notifications.email.marketing = !userSettings
    ...
    actions: [
      {
        ...
        disabledText: "Off",
        onClick: () => {
          userSettings.notifications.email.criticalAlerts = !userSettings
    ...
    actions: [
      {
        ...
        onClick: () => {
          userSettings.preferences.darkMode = !userSettings.preferences
            .darkMode;
    ...
    actions: [
      {
        ...
        onClick: () => {
          userSettings.preferences.autoSave = !userSettings.preferences
            .autoSave;
